...
const fakeAlphabet = {
    a: [ 'alphons', 'aloe', 'afore' ],
    b: [ 'brave', 'barley', 'behemoth' ],
    c: [ 'charles', 'charokee', 'cheers' ],
    d: [ 'detain', 'dream', 'demon' ],
    e: [ 'etch', 'earth', 'each' ],
    f: [ 'footpad', 'foxhound', 'fountain' ],
    g: [ 'gulp', 'grown', 'gollum' ],
    h: [ 'hooter', 'hail', 'hello' ],
    i: [ 'intent', 'impact', 'isizulu' ],
    j: [ 'julian', 'james', 'jules' ],
    k: [ 'kilogram', 'khoi', 'kelloggs' ],
    l: [ 'llama', 'lyme', 'lion' ],
    m: [ 'meek', 'movember', 'malice' ],
    n: [ 'norton', 'nails', 'neighbour' ],
    o: [ 'osiris', 'oops', 'oliver' ],
    p: [ 'papaya', 'penal', 'ploy' ],
    q: [ 'queen', 'quake', 'quintus' ],
    r: [ 'romero', 'revel', 'remember' ],
    s: [ 'siren', 'salazar', 'sophia' ],
    t: [ 'topaz', 'team', 'tardy' ],
    u: [ 'ubiquitous', 'unique', 'unsullied' ],
    v: [ 'vector', 'vortex', 'victory' ],
    w: [ 'wine', 'wholly', 'werewolf' ],
    x: [ 'x-wing', 'xerox', 'x-ing' ],
    y: [ 'yonder', 'yellow', 'yanks' ],
    z: [ 'zucchini', 'zephyr', 'zone' ],
};
const fakeNumbers = {
    1: [ 'oen', 'oon', '1' ],
    2: [ 'tow', 'too', '2' ],
